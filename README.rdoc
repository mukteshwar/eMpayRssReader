== Welcome to eMerchantpay's RSS Reader

Simple RSS reader

If you are using Google reader, or any RSS reader, then you must be familiar what RSS readers generally do.

Very basic RSS-reader do following tasks:
